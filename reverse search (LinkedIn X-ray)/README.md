...
Complementaire, pas un remplacement, de [`job_reversed_search/`](../job_reversed_search) —
celui-ci tourne sur PhantomBuster (LinkedIn Search Export, cote candidat/entreprise Figma+React),
