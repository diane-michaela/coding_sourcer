...
(async function () {
  ...
  // result's locale. English: "<Company> hiring <Role> in <Location> |
  // LinkedIn". French: "<Role> chez <Company>" (optionally with " —
  // <Location>" tacked on) " | LinkedIn". Less often: "<Role> - <Company>
  // | LinkedIn". Parse all three; anything else leaves Company blank
